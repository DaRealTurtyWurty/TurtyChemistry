...
import io.github.darealturtywurty.turtychemistry.client.ui.components.WorldPreviewWidget;
...
public class ShaleFracturerScreen extends ContainerMachineScreen<ShaleFracturerContainer> implements TabHolder<Tab> {
    ...
    private void addHomeWidgets() {
        ...
        this.speedInfo = addRenderableWidget(new InformationWidget(this,
                this.leftPos + 20 + this.font.width(HomePage.SPEED) + this.speedInput.getWidth() + 5, this.topPos + 47,
                16, 16, HomePage.SPEED_INFO_TOOLTIP.toArray(new Component[0])));

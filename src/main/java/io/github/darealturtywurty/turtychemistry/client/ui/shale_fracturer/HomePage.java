...
public class HomePage extends TabPage {
    protected static final Component SPEED = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".input.speed").append(": ");
    protected static final Component LIMIT_ENERGY = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".input.limit_energy").append(": ");
    protected static final Component LIMIT_WATER = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".input.limit_water").append(": ");
    protected static final MutableComponent ON_OFF_LABEL = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".label.on_off");
    protected static final MutableComponent EXTEND_DRILL_LABEL = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".label.extend_drill");
    protected static final Component CONFIRM_BUTTON = new TranslatableComponent(
            TurtyChemistry.MODID + ".button.confirm");
    protected static final Component CANCEL_BUTTON = new TranslatableComponent(TurtyChemistry.MODID + ".button.cancel");
    protected static final Component TURN_ON = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".popout.label.turn_on");
    protected static final Component TURN_OFF = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".popout.label.turn_off");
    protected static final Component RETRACT_DRILL = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".popout.label.retract_drill");
    protected static final Component EXTEND_DRILL = new TranslatableComponent(
            "page.home." + TurtyChemistry.MODID + ".popout.label.extend_drill");
    protected static final List<Component> SPEED_INFO_TOOLTIP = List.of(
            new TranslatableComponent("page.home." + TurtyChemistry.MODID + ".info.speed_0"),
            new TranslatableComponent("page.home." + TurtyChemistry.MODID + ".info.speed_1"));

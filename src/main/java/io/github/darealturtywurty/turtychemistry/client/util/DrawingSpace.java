...
import io.github.darealturtywurty.turtychemistry.network.PacketHandler;
import io.github.darealturtywurty.turtychemistry.network.serverbound.SMolderClickPacket;
...
public final class DrawingSpace extends AbstractButton {
    ...
    public void onRelease(final double pMouseX, final double pMouseY) {
        ...
        if (!molderScreen.getCurrentStack().isEmpty()) {
            ...
            PacketHandler.CHANNEL.sendToServer(new SMolderClickPacket(pos, molderScreen.getCurrentStack()));
        }

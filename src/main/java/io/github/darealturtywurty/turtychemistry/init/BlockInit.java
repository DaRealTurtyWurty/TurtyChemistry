...
import io.github.darealturtywurty.turtychemistry.block.*;
import io.github.darealturtywurty.turtychemistry.worldgen.tree.RubberTreeGrower;
...
import static io.github.darealturtywurty.turtychemistry.block.ChemistryBlock.Builder.build;
...
public final class BlockInit extends AbstractInit {
    ...
    public static final RegistryObject<ClayAlloyFurnaceBlock> CLAY_ALLOY_FURNACE = BLOCKS.register("clay_alloy_furnace",
            () -> new ClayAlloyFurnaceBlock(
                    BlockBehaviour.Properties.copy(Blocks.TERRACOTTA).dynamicShape().noOcclusion()));

    public static final RegistryObject<Block> RUBBER_TREE_SAPLING = register("rubber_tree_sapling",
            () -> new SaplingBlock(new RubberTreeGrower(), BlockBehaviour.Properties.copy(Blocks.ACACIA_SAPLING)),
            new Item.Properties().tab(TurtyChemistry.TAB));

    public static final RegistryObject<RubberLogBlock> RUBBER_TREE_BLOCK = register("rubber_tree_block",
            () -> new RubberLogBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_LOG)),
            new Item.Properties().tab(TurtyChemistry.TAB));
    public static final RegistryObject<StrippedRubberLogBlock> RUBBER_TREE_BLOCK_STRIPPED = register(
            "rubber_tree_block_stripped",
            () -> new StrippedRubberLogBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_ACACIA_LOG)),
            new Item.Properties().tab(TurtyChemistry.TAB));
    ...
    public static final RegistryObject<RubberTreeTapBlock> RUBBER_TREE_TAP = register("rubber_tree_tap",
            () -> new RubberTreeTapBlock(BlockBehaviour.Properties.of(Material.METAL)),
            new Item.Properties().tab(TurtyChemistry.TAB));

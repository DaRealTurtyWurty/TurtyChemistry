...
public class ItemInit extends AbstractInit {
    ...
    public static final RegistryObject<ChemistryItem> CYAN_TEST_TUBE = ITEMS.register("cyan_test_tube",
            () -> new ChemistryItem(makeItemProperties()));
    public static final RegistryObject<ChemistryItem> LIGHT_GRAY_TEST_TUBE = ITEMS
            .register("light_gray_test_tube", () -> new ChemistryItem(makeItemProperties()));
    ...
    public static final RegistryObject<ChemistryItem> YELLOW_TEST_TUBE = ITEMS.register("yellow_test_tube",
            () -> new ChemistryItem(makeItemProperties()));
    public static final RegistryObject<ChemistryItem> LIGHT_BLUE_TEST_TUBE = ITEMS
            .register("light_blue_test_tube", () -> new ChemistryItem(makeItemProperties()));
    ...
    public static final RegistryObject<ChemistryItem> TEST_TUBE = ITEMS.register("test_tube",
            () -> new ChemistryItem(makeItemProperties()));
    public static final RegistryObject<WaterLilyBlockItem> GREEN_ALGAE = ITEMS.register("green_algae",
            () -> new WaterLilyBlockItem(BlockInit.GREEN_ALGAE.get(),

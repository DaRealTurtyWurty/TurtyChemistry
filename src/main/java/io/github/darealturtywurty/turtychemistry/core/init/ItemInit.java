...
public final class ItemInit extends AbstractInit {
    ...
    public static final ImmutableMap<Supplier<RegistryObject<? extends Item>>, Supplier<RegistryObject<? extends Item>>> INGOT_SHEET_MAP = ImmutableMap.<Supplier<RegistryObject<? extends Item>>, Supplier<RegistryObject<? extends Item>>>builder()

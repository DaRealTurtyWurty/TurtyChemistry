...
public final class ServerBoundUpdateRubberTreeTapPacket {
    public final BlockPos treeTapBlockPos;
    public final boolean isTapping;

    public ServerBoundUpdateRubberTreeTapPacket(final BlockPos pos, final boolean isTapping) {
        this.treeTapBlockPos = pos;
        this.isTapping = isTapping;
    }

    public ServerBoundUpdateRubberTreeTapPacket(final FriendlyByteBuf byteBuf) {

...
public class ModConfiguredFeatures {
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> RUBBER_TREE = register("rubber_tree", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(BlockInit.RUBBER_TREE_BLOCK.get()), new RubberTreeTrunkPlacer(5, 2, 1, ConstantInt.of(5), UniformInt.of(1, 2)), BlockStateProvider.simple(BlockInit.RUBBER_TREE_LEAVES.get()), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 0, 1)).ignoreVines().build());
